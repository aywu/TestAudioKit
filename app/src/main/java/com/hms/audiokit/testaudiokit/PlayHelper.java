...
public class PlayHelper {
    ...
    public void init(final Context context, final MainActivity.PlayerCallback callback) {
    ...
    public void buildLocal(Context context) {
        if (context != null && mHwAudioPlayerManager != null) {
            Log.i(TAG, "buildLocal(): start playing ...");
            mHwAudioPlayerManager.playList(sampleData.getLocalPlayList(context), 0, 0);
        } else {
            Log.i(TAG, "buildLocal(): context or player manager is null");
        }
    }
    ...
    public void play() {
        Log.i(TAG, "play");
        if (mHwAudioPlayerManager == null) {
            Log.w(TAG, "play err: mHwAudioPlayerManager is null");
            return;
        }
